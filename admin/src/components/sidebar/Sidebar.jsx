...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='relative ml-4 max-h-screen  z-10  '>
      {/* <div className="absolute inset-0 flex items-center  justify-center px-80">
        <h1>Welcome to </h1>
      </div> */}
 ...
 <NavLink to='/add' onClick={handleClose} className=' px-4 py-1 hover:bg-green-300'>
          Add Item
          </NavLink><br/>
        <NavLink to='/list' onClick={handleClose} className='px-4 py-1 hover:bg-green-300'>
